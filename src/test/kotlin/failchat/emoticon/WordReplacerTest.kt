...
class WordReplacerTest {
    ...
    fun replaceNothingTest() {
        ...
        val resultString =
            WordReplacer.replace(initialString) {
                actualWords.add(it)
    ...
    fun replaceAllTest() {
        val resultString =
            WordReplacer.replace("just a simple message") { ReplaceDecision.Replace("42") }
    ...
    fun specialCharactersTest() {
        ...
        val resultString = WordReplacer.replace(initialString) { ReplaceDecision.Replace("1") }
