...
class YoutubeTest {
    ...
    */
    //    private suspend fun sendLiveChatRequest(continuation: String, innertubeApiKey: String,
    // sessionId: String): LiveChatResponse {
    ...
    //
    //
    //        val liveChatRequestBody = RequestBody.create(MediaType.parse("application/json"),
    // objectMapper.writeValueAsString(requestBodyDto))
    //
    //        val liveChatRequest = Request.Builder()
    //                .post(liveChatRequestBody)
    //                .url(messageRequestUrl)
    //                .addHeader("User-Agent", "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0)
    // Gecko/20100101 Firefox/79.0")
    //                .addHeader("Accept", "*/*")
    //                .addHeader("Accept-Language", "en-GB,en;q=0.5")
    //                .addHeader("Referer",
    // "https://www.youtube.com/live_chat?is_popout=1&v=iwBU6JG6ZyY")
