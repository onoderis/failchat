...
class EmoticonCodeIdDbCompactStorage(
    ...
    init {
        lowerCaseCodeToId =
            db.hashMap(
                    origin.commonName + "-lowerCaseCodeToId",
                    Serializer.STRING,
                    Serializer.STRING,
                )
                .createOrOpen()
        idToNormalCaseCode =
            db.hashMap(
                    origin.commonName + "-idToNormalCaseCode",
                    Serializer.STRING,
                    Serializer.STRING,
                )
                .createOrOpen()
    ...
    override fun getAll(): Collection<Emoticon> = throw NotImplementedError()

    override fun count(): Int = idToNormalCaseCode.size
