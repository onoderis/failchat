...
class ChatMessageSender(
    ...
    fun send(message: ChatMessage) {
        val messageNode: ObjectNode =
            objectMapper.nodeFactory.objectNode().apply {
                put("type", "message")
                with("content").apply {
                    put("id", message.id)
            ...
            objectMapper.nodeFactory.objectNode().apply {
                ...
                putObject("content").apply {
                    ...
                    put(
                        ...
                        config.getString(ConfigKeys.deletedMessagePlaceholder),
                    )
                    ...
                    putObject("nativeClient").apply {
                        ...
                        put(
                            "hideMessagesAfter",
                            config.getInt(ConfigKeys.NativeClient.hideMessagesAfter),
                        )
                        put(
                            "showStatusMessages",
                    ...
                    putObject("externalClient").apply {
                        put(
                            "backgroundColor",
                            config.getString(ConfigKeys.ExternalClient.backgroundColor),
                        )
                        put(
                            "coloredNicknames",
                        ...
                        put(
                            "hideMessages",
                            config.getBoolean(ConfigKeys.ExternalClient.hideMessages),
                        )
                        put(
                            "hideMessagesAfter",
                            config.getInt(ConfigKeys.ExternalClient.hideMessagesAfter),
                        )
                        put(
                            "showStatusMessages",
                    ...
                    putObject("enabledOrigins").apply {
                        COUNTABLE_ORIGINS.forEach { origin ->
                            put(
                                origin.commonName,
                                config.getBoolean("${origin.commonName}.enabled"),
                            )
                        }
                    }
                    putObject("deletedMessagePlaceholder").apply {
                        ...
                        set<ObjectNode>(
                            "elements",
                            serializeElements(deletedMessagePlaceholder.emoticons),
                        )
                    }
                }
            }
