...
enum class Origin(val commonName: String) {
    // todo rename to MessageOrigin, remove BTTV
    GOODGAME("goodgame"),
    TWITCH("twitch"),
    ...
    companion object {
        ...
        fun byCommonName(name: String): Origin =
            map[name] ?: throw IllegalArgumentException("No origin found with name '$name'")
    }
}

val chatOrigins = listOf(Origin.GOODGAME, Origin.TWITCH, Origin.YOUTUBE)
