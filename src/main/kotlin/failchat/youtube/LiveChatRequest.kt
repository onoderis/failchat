...
data class LiveChatRequest(val context: Context = Context(), val continuation: String) {
    data class Context(
    ...
    data class Client(
        ...
        val userAgent: String =
            "Mozilla/5.0 (Windows NT 10.0; Win64; x64; rv:79.0) Gecko/20100101 Firefox/79.0,gzip(gfe)",
